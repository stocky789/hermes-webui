...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    git_not_repo: 'This workspace is not a Git repository.',
    git_stage: 'Stage',
    git_stage_all: 'Stage all',
    git_stage_selected: 'Stage selected',
    git_stage_selected_title: 'Stage the checked files that have unstaged or untracked changes.',
    git_unstage: 'Unstage',
    git_discard: 'Discard',
    git_discard_selected: 'Discard selected',
    git_discard_delete_selected: 'Discard/delete selected',
    git_discard_selected_title: 'Discard local changes and delete checked untracked files.',
    git_discard_selected_confirm_title: 'Discard selected changes?',
    git_discard_selected_confirm_message: (count) => `Discard changes for ${count} selected file${count === 1 ? '' : 's'}? Untracked files in the selection will be deleted. This cannot be undone.`,
    git_commit: 'Commit',
    ...
    git_pulled: 'Pulled',
    git_pushed: 'Pushed',
    git_sync_failed: 'Git action failed',
    git_diff_too_large: 'Diff is too large to display completely',
    git_binary_file: 'Binary file',
    git_conflicts: 'Conflicts',
    git_tracked: 'Tracked',
    git_untracked: 'Untracked',
    git_staged: 'Staged',
    git_unstaged: 'Changes',
    git_select_files: 'Select files to commit',
    git_commit_message_privacy: 'Generating a message sends the selected diff to your configured model provider.',
    editor_soft_wrap: "Soft wrap",
    unsaved: "Unsaved",
    git_current_branch: "Current branch",
    git_local_branches: "Local branches",
    git_remote_branches: "Remote branches",
    git_create_branch: "Create branch",
    git_new_branch_name: "new-branch",
    git_fetch_refresh: "Fetch refresh",
    git_no_branches: "No branches",
    git_checked_out: "Checked out",
    git_checkout_failed: "Checkout failed",
    git_diff_unified: "Unified",
    git_diff_split: "Split",
    git_checkout_dirty_title: "Checkout blocked",
    git_checkout_dirty_message: "The worktree has uncommitted changes. Stash local changes and switch branch?",
    git_stash_and_switch: "Stash and switch",
    git_stashed: "Stashed",
    git_stashed_local_changes: "saved local changes",
    git_restored_local_changes: "restored local changes",
    git_restore_failed: "Could not restore local changes",
    open: 'Open',
    open_file: 'Open file',
    git_discard_confirm_title: 'Discard changes?',
    git_discard_confirm_message: (path) => `Discard local changes in ${path}? This cannot be undone.`,
    git_delete_untracked_confirm: (path) => `Delete untracked file ${path}? This cannot be undone.`,
  ...
  tr: {
    ...
    // English fallbacks for workspace Git UI keys pending Turkish translation.
    git_files: 'Files',
    git_changes: 'Changes',
    git_changed: 'changed',
    git_no_changes: 'No changes',
